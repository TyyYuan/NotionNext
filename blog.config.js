...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tyyma_Admin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '自由主义学者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tyyma.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '留学，免费，资源，托福，AP', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1842408314@qq.com', // 邮箱地址 例如mail@tangly1024.com
